...
implicit none
   ...
   ec = ec + get_map_contribution(p%hs,p%mapFactor)
...
subroutine get_total_potential_energy_pbme_traceless(pairs,p,ec,ecslj,ecsel,ecst,esslj,essel,essb,esst,et)
use maproutines
implicit none
   ...
   call get_solventsolvent_energy(pairs,esslj,essel,essb,esst)
   et = ec + ecst + esst
end subroutine get_total_potential_energy_pbme_traceless
